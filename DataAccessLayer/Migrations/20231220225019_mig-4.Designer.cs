...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20231220225019_mig-4")]
    partial class mig4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Arsa", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Talep", "Talep")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccessLayer.Ilan", b =>
                {
                    b.HasOne("DataAccessLayer.IlanTalepTipi", "IlanTalepTipi")
                        .WithMany("Ilanlar")
                        .HasForeignKey("IlanTalepTipiId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataAccessLayer.Satici", "Satici")
                        .WithMany("Ilanlar")
            ...
            modelBuilder.Entity("DataAccessLayer.Talep", b =>
                {
                    b.HasOne("DataAccessLayer.Alici", "Alici")
                        .WithMany("Talepler")
            ...
            modelBuilder.Entity("DataAccessLayer.Tarla", b =>
                {
                    ...
                    b.HasOne("DataAccessLayer.Talep", "Talep")
                        .WithOne("Portfoy")
                        .HasForeignKey("DataAccessLayer.Tarla", "TalepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
