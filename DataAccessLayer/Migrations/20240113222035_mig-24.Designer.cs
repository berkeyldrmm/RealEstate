...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20240113222035_mig-24")]
    partial class mig24
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityLayer.Entities.Arsa", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entities.Talep", "Talep")
                        .WithOne("Arsa")
                        .HasForeignKey("EntityLayer.Entities.Arsa", "TalepId");
            ...
            modelBuilder.Entity("EntityLayer.Entities.Daire", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entities.Talep", "Talep")
                        .WithOne("Daire")
                        .HasForeignKey("EntityLayer.Entities.Daire", "TalepId");
            ...
            modelBuilder.Entity("EntityLayer.Entities.Depo", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entities.Talep", "Talep")
                        .WithOne("Depo")
                        .HasForeignKey("EntityLayer.Entities.Depo", "TalepId");
            ...
            modelBuilder.Entity("EntityLayer.Entities.Dukkan", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entities.Talep", "Talep")
                        .WithOne("Dukkan")
                        .HasForeignKey("EntityLayer.Entities.Dukkan", "TalepId");
            ...
            modelBuilder.Entity("EntityLayer.Entities.Tarla", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Entities.Talep", "Talep")
                        .WithOne("Tarla")
                        .HasForeignKey("EntityLayer.Entities.Tarla", "TalepId");
